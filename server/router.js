...
module.exports = function(app) {
    ...
    router.get('/weeklyplan/:startDate', userApi.authenticate, weeklyApi.getWeeklyPlan);
    router.post('/weeklyplan/:startDate',  userApi.authenticate, weeklyApi.createWeeklyPlan);
    router.put('/weeklyplan/:startDate', userApi.authenticate, weeklyApi.updateWeeklyPlan);
